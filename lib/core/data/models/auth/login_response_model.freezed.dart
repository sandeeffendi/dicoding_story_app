...
mixin _$LoginResponseModel {
 ...
 bool get error; String get message; LoginResultModel get loginResult;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginResponseModel&&(identical(other.error, error) || other.error == error)&&(identical(other.message, message) || other.message == message)&&(identical(other.loginResult, loginResult) || other.loginResult == loginResult));
}
...
@useResult
$Res call({
 bool error, String message, LoginResultModel loginResult
});


$LoginResultModelCopyWith<$Res> get loginResult;
...
$LoginResultModelCopyWith<$Res> get loginResult {
  ...
  return $LoginResultModelCopyWith<$Res>(_self.loginResult, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool error,  String message,  LoginResultModel loginResult)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginResponseModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool error,  String message,  LoginResultModel loginResult)  $default,) {final _that = this;
switch (_that) {
case _LoginResponseModel():
return $default(_that.error,_that.message,_that.loginResult);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool error,  String message,  LoginResultModel loginResult)?  $default,) {final _that = this;
switch (_that) {
case _LoginResponseModel() when $default != null:
return $default(_that.error,_that.message,_that.loginResult);case _:
  return null;
...
class _LoginResponseModel implements LoginResponseModel {
  const _LoginResponseModel({required this.error, required this.message, required this.loginResult});
...
@override final  LoginResultModel loginResult;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoginResponseModel&&(identical(other.error, error) || other.error == error)&&(identical(other.message, message) || other.message == message)&&(identical(other.loginResult, loginResult) || other.loginResult == loginResult));
}
...
@override $LoginResultModelCopyWith<$Res> get loginResult;
