...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginResultModel&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.name, name) || other.name == name)&&(identical(other.token, token) || other.token == token));
}
...
switch (_that) {
case _LoginResultModel():
return $default(_that.userId,_that.name,_that.token);}
}
...
class _LoginResultModel implements LoginResultModel {
  const _LoginResultModel({required this.userId, required this.name, required this.token});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoginResultModel&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.name, name) || other.name == name)&&(identical(other.token, token) || other.token == token));
}
